...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Tunjuk</b>.in</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  @yield('Username') - Administrator
                  <small>Tunjuk.in</small>
                </p>
              </li>
              <!-- Menu Body -->
              <!-- <li class="user-body">
...
@yield ('content')
  ...
  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      <b>In the amazing</b> 2019
    </div>
    <strong>&copy; <a href="https://adminlte.io">AdminLTE</a></strong> ft. TRPL Pariwisata
  </footer>
