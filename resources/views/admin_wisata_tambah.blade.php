  ...
  <div class="box">
    <div class="box-header with-border">
      ...
      <div class="box-tools pull-right">
        <a href="{{route('wisata_admin.index')}}" class="btn btn-box-tool"><i class="fa fa-plus-circle"></i>Batal</a>
    ...
    <div class="box">
      ...
      <div class="box-body">
        <form role="form" method="POST" action="{{route('wisata_admin.store')}}" enctype="multipart/form-data">
          @csrf
          <div class="box-body">
