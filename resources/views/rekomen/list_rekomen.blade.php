...
@section('page_title')
    Rekomendasi Liburan - Pilih Wisata
@endsection
...
<section class="ftco-section ftco-degree-bg">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-12">
            <h3>Pilih tempat wisata di bawah untuk mendapatkan rekomendasi penginapan dan wisata kuliner:</h3>
            @if(count($wisata) == 0)
                Tidak ada hasil yang sesuai,
                harap ulangi pencarian anda!
            @else
                ...
                <div class="col-sm col-md-6 col-lg-4 ftco-animate">
                    <div class="destination">
                        <a href="{{route('Detail_Wisata', ['Detail_Wisata' => $value->id])}}"
                           ...
                           style="background-image: url({{asset('image/wisata/'.$value->image)}})">
...
{{--                                    </p>--}}
                            ...
                            <form action="{{route('rekomendasi.rekHotel')}}" method="post">
                                @csrf
                                <input type="hidden" name="WisataID" id="WisataID" value="{{$value->id}}">
                                ...
                                <input type="submit" class="ml-auto" value="Pilih Wisata">
                                {{--                                        <span class="ml-auto"><a href="{{route('rekomendasi.show', ['rekomendasi' => $value->id])}}">Pilih Tempat Wisata</a></span>--}}
                            </form>
{{--                                <span class="ml-auto"><a href="{{route('rekomendasi.show', ['rekomendasi' => $value->id])}}">Pilih Tempat Wisata--}}
{{--                                    </a></span>--}}
                            </p>
{{--                            <p class="bottom-area d-flex">--}}
