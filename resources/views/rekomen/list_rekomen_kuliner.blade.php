...
@section('content')
    ...
    <section class="ftco-section ftco-degree-bg">
        <div class="container">
                            ...
                            <div class="col-md align-items-end">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-field">
                                        ...
                                        <input type="text" class="form-control checkin_date" placeholder="Mulai" id="checkIn" name="checkIn" value="{{$input['start']}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md align-items-end">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-field">
                                        <div class="icon"><span class="icon-map-marker"></span></div>
                                        <input type="text" class="form-control checkout_date" placeholder="Selesai" id="checkOut" name="checkOut" value="{{$input['finish']}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md align-items-end">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3>Pilih Tempat Kuliner:</h3>
                    @if(count($hasil) == 0)
                        Tidak ada hasil yang sesuai,
                        <form action="{{route('rekomendasi.final')}}" method="post">
                            @csrf
                            {{--                                        <input type="hidden" name="HotelID" id="HotelID" value="{{$value->id}}">--}}
                            <input type="hidden" name="WisataID" id="WisataID" value="{{$input['WisataID']}}">
                            <input type="hidden" name="HotelID" id="HotelID" value="{{$input['HotelID']}}">
                            ...
                            <input type="hidden" name="KulinerID" id="KulinerID" value="">
                            ...
                            <input type="hidden" value="" name="jarakKuliner">
                            <input type="hidden" value="{{$input['jarakHotel']}}" name="jarakHotel">
                            <input type="hidden" value="{{$input['costHotel']}}" name="costHotel">
                            <input type="hidden" value="{{$input['costWisata']}}" name="costWisata">
                            <input type="hidden" value="" name="costKuliner">
                            <input type="hidden" value="{{$input->kategori}}" name="kategori">
                            <input type="submit" class="ml-auto" value="Langsung ke Hasil Rekomendasi Liburan Anda">
                        ...
                        @foreach($hasil as $value)
                            <div class="col-sm col-md-6 col-lg-4 ftco-animate">
                                <div class="destination">
                                    <a href="{{route('Detail_Kuliner', ['Detail_Kuliner' => $value->id])}}"
                                       class="img img-2 d-flex justify-content-center align-items-center"
                                       style="background-image: url({{asset('image/kuliner/'.$value->image)}})">
                                    ...
                                    dari</small></span>
                                        ...
                                        <p>Jarak Kuliner : {{$jarak}} meter dari wisata</p>
                                        <form action="{{route('rekomendasi.final')}}" method="post">
                                            @csrf
                                            {{--                                        <input type="hidden" name="HotelID" id="HotelID" value="{{$value->id}}">--}}
                                            <input type="hidden" name="WisataID" id="WisataID" value="{{$input['WisataID']}}">
                                            <input type="hidden" name="HotelID" id="HotelID" value="{{$input['HotelID']}}">
                                            <input type="hidden" name="KulinerID" id="KulinerID" value="{{$value->id}}">
                                            <input type="hidden" value="{{$input['bWisata']}}" name="bWisata">
                                            <input type="hidden" value="{{$input['bKuliner']}}" name="bKuliner">
                                            <input type="hidden" value="{{$input['bHotel']}}" name="bHotel">
                                            <input type="hidden" value="{{$input['biayaWisata']}}" name="biayaWisata">
                                            ...
                                            <input type="hidden" value="{{$input['start']}}" name="start">
                                            <input type="hidden" value="{{$input['finish']}}" name="finish">
                                            <input type="hidden" value="{{$value->distance}}" name="jarakKuliner">
                                            <input type="hidden" value="{{$input['jarakHotel']}}" name="jarakHotel">
                                            <input type="hidden" value="{{$input['costHotel']}}" name="costHotel">
                                            <input type="hidden" value="{{$input['costWisata']}}" name="costWisata">
                                            <input type="hidden" value="{{($value->tarif_atas + $value->tarif_bawah) /2}}" name="costKuliner">
                                            <input type="hidden" value="{{$input['kategori']}}" name="kategori">
                                            <input type="submit" class="ml-auto" value="Pilih Kuliner">
                                            {{--                                        <span class="ml-auto"><a href="{{route('rekomendasi.show', ['rekomendasi' => $value->id])}}">Pilih Tempat Wisata</a></span>--}}
                                        </form>
                                        </p>
